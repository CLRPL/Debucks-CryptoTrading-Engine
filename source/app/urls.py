...
urlpatterns = [
    ...
    path('dashboard/', main.views.DashboardPageView.as_view(), name='dashboard'),
    path('swap/', main.views.SwapPageView.as_view(), name='swap'),
    path('contact_us/', main.views.ContactUsPageView.as_view(), name='contact_us'),
    path('api/', main.views.ApiPageView.as_view(), name='api'),
    path('settings/', main.views.SettingsPageView.as_view(), name='settings'),
